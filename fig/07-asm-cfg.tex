...
\begin{frame}[fragile]
  \begin{tikzpicture}[
    ...
    bb label/.style={bb=#1,
      label={[visible on=<-4>,anchor=north east]north west:.#1:},name=#1}
    ]
...
\node[below=0 of BB0.south west,bb=BB1,onslide=<5->{xshift=1cm}](BB1){
        mov     EAX, 3\\
        cmp     EDX, 14\\
        jl      .BB3
      };
\node[below=0 of BB1.south west,bb=BB2,onslide=<5->{xshift=1cm}](BB2){
  mov     EAX, 13
};
\node[below=0 of BB2.south west,bb label=BB3,onslide=<5->{xshift=-2cm}]{
        add     EAX, EAX\\
        inc     EDI\\
        jne     .BB3
      };
\node[below=0 of BB3.south west,bb=BB4](BB4){
  ret
};
...
\node[anchor=north west, minimum width=5.5cm,minimum height=8cm]{};
