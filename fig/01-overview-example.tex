...
\begin{frame}[fragile]
  \begin{tikzpicture}
    \only<1>{
    \node[inner sep=1,draw] (code) {\texttt{if ( a >b)\{return b; \} else return b;}};
    \foreach \i in {1,...,36} {
    ...
    \only<3-4>{
      ...
      \node[bb] (bb0) at (7cm, -2cm) {bb0:\\\ \ load tmp0, \textbf{\$b}\\\ \ iflt tmp0, a, bb1, bb2};
      \node[bb,below=0.5 of bb0,xshift=-1cm] (bb1) {bb1:\\\ \ return a;};
      \node[bb,below=1.5 of bb0,xshift=1cm] (bb2) {bb1:\\\ \ load tmp2, \textbf{\$b};\\ \ \ return tmp2};
