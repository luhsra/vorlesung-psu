...
\node[right=1.5 of parsing.north east,topic,lecture=8] (intermediate) {
    \Title{Zwischencode}\\
    3-Address Code\\
  ...
  \node[right=1.5 of semantic.north east,topic,lecture=10] (machine) {
    \Title{Maschinencode}\\
    Registerallokation\\
    Funktionsaufrufe\\
  ...
  \node[right=1.5 of intermediate.north east,topic,lecture=10] (opt) {
    \Title{Optimierung}\\
    Fixpunkt Analyse\\
  ...
  \node[right=1.5 of machine.north east,topic,lecture=11] (runtime) {
