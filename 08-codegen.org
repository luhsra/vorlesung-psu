...
Bei der Stack-Maschine lassen die Ausführungen von AST-Unterbäumen ihr Ergebnis auf dem Stack liegen, bei Register-Maschinen wird das Ergebnis in ein explizit benanntes Register geschrieben.
