...
Im Laufe Ihres Lebens wird an Sie, nachdem entschieden wurde Programmiersprache R++ in Version 2034 zu verwenden, die Anforderung gestellt werden, möglichst schnell **effektiv** darin zu werden ein möglichst **effizientes** Programm zu schreiben.
...
Dabei werfen wir auch noch kurzen Blick auf den nachgelagerten Schritt der Linkens (FIXME), der neben dem Assemblieren, die letzten Schritte zum ausführbaren Binärprogramm fehlt.
...
Es ist natürlich notwendig, dass ein Übersetzer für jedes valide Quellprogramm, was er durch seine Validierungsfunktion sicherstellt, ein valides Zielprogramm erzeugt.
