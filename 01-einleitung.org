...
#+BEGIN_SRC latex
  ...
  \begin{frame}[t]{Organisatorisches: Übungen}
    ...
    \bi
    \ii Tafelübungen: 6 Termine {
      \bi
      \ii Verantwortlicher: \textbf{Tobias Landsberg}
      \ii Freitag 10:30-12:00 Uhr, https://twitch.tv/luhsra
      \ii Live-Stream mit Rückkanal, Vorlesungsaufzeichnung im Stud.IP
      \ii Vertiefung der Vorlesung, Erörterung der Übungsaufgaben
      \ei
    }\medskip
    \ii Übungen: 6 Aufgaben mit theoretischem und praktischen Anteil {
      \bi
      ...
      \ii Bearbeitung in \textbf{Zweierteams}, Abgabe mit Git und SRAbmit
      \ei
    }\medskip
    \ii Bonuspunkte auf die Klausur {
      \bi
      \ii Bewertung der Übungsaufgaben, maximal +10\%  Klausurpunkte
      \ii Bonuspunkte helfen \ALERT{nicht} über die Bestehensgrenze.
      \ei
    }
    \ei
  \end{frame}
