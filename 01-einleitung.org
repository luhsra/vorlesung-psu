...
Bei dieser erweiterten Definition von korrekter Übersetzung, erwarten wir nicht nur das Zielprogramm das gleiche Ergebnis berechnet und uns über den Ausgabekanal mitteilt, sondern auch dass es dies auf die gleiche Weise tut.
Das Zielprogramm soll, im Grunde, die gleichen Schritte durchführt wie das Quellprogramm, nur auf einer anderen Maschine. Um dies formaler zu fassen, führen wir auf den Folien den Begriff der *beobachtbaren Zustand* ein.
