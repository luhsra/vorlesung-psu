...
#+begin_src latex
  \begin{frame}[fragile]{Destruktoren}
    ...
    \medskip
    \bi
    \ii Destruktoren macht die Seiteneffekte des Konstruktors rückgängig{
      \bi
    ...
    \ii Destruktoren und Vererbung: Umgekehrte Konstruktionsreihenfolge  {
      \bi
      \ii Destruktor...
      \ei
      }
...
#+begin_src latex
  \begin{frame}{Fallstudie: Resource Aquisition is Initialization (RAII)}
