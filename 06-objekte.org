...
Da Besitz von Objekten schwierig ist, gibt es moderne Sprachkonzepte, wie den ~std::unique_ptr<>~ von C++ und den Borrowchecker von Rust, die es leichter machen beim Besitzen von Objekten weniger falsch zu machen.
