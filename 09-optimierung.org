  ...
  \begin{frame}{Verschmelzen von konsekutiven Basisblöcken}
    \begin{columns}
      \begin{column}{0.4\textwidth}
        \btAnimation[width=\textwidth]{range=1-3:<1->,3:<4->}{fig/09-block-merge}
      \end{column}\hfill
      \begin{column}{0.6\textwidth}
        ...
        \ii \textbf{Problem}: Sprung zu BB1 ist überflüssig.{
          ...
          \ii[$\Rightarrow$] \textbf{Ziel}: Verschmelze beide BB0 und BB1
          \ei
        }\medskip
        \ii<2-> \textbf{Analyse}: Finde Block-Paar (x, y), sodass\ldots{
          \bi
