...
#+begin_src latex
  ...
  \begin{frame}[fragile]{Sequenzierung: Statements}
    \bi
    \ii \structure{Sequenzierung}: Einfachste Form der Abhängigkeitsnotation {
      \bi
      \ii Der Sequenzoperator (\codebox{;})führt seine Kinder in eine strikten Reihenfolge aus
    ...
    \ii<2-> Statements sind das grundlegende Sprachmittel in imperativen Sprachen\\ {
