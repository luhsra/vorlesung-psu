...
In dieser Vorlesung widmen wir uns wieder einem der essenziellen Konzepten von Programmiersprachen:
*Operationen*.
...
Zunächst beschäftigen wir uns mit *arithmetischen, bit-weisen und logischen Operationen*, die in allen Programmiersprachen auftauchen, da wir ansonsten nichts ausrechnen können.
...
Daher ist dieser CFG dafür geeignet den Code einer einzelnen Funktion zu erzeugen und zu optimieren. Deswegen ist der funktionslokale CFG auch der normale CFG.
