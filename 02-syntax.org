...
Die andere Variante ist das Umformen der Regeln mittels *Linksfaktorisierung*. Dabei spalten wir die zweideutigen A-Produktionen auf indem wir ein weiteres ~_tail~ Nicht-Terminal einführen. Das orginale Nicht-Terminal (~stmt~) hat nur
