...
#+begin_src latex
  ...
  \begin{frame}[fragile]{Zyklisch-abhängige Attribute}
    ...
    \ii<4-> \structure{Typinferenz} erleichtert statische Typisierung, erzeugt aber Zyklen{
      ...
      \ii \structure{Hindley-Milner Typinferenz} ist, kombiniert mit parametrischem Polymorphismus, die Grundlage der \alert{funktionalen Programmierung}
      \ei
    }
    \ei
  \end{frame}
  ...
  \begin{frame}[fragile]{Typinferenz durch Ersetzung von Typvariablen}
    \begin{columns}
      ...
      \begin{column}{0.58\textwidth}
        ...
        \ii<2-> Knoten führen \structure{Nebenbedingungen} ein{
          \bi
        ...
        \ii<3->Variablen-Elimination durch \structure{Ersetzungen}{
          \bi
          \ii Ersetze jede Variable durch Typausdruck
          \ii Nebenbedingungen \alert<-5>{müssen erfüllt} werden!
          \ii Fertig, wenn es \alert<6>{keine freie Variable} mehr gibt
          \ei
        }
        \eii
