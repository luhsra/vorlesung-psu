...
#+begin_src latex
  ...
  \begin{frame}[fragile]{Pointer, Aliase und Uneindeutigkeit}
    ...
    \ei
    \OrangeBox<5->{Wäre es nützlich, wenn ein Name Objekte meinen könnte?}
  \end{frame}
  ...
  \begin{frame}{Namensauflösung für überladene Funktionen}
    \begin{columns}[t]
      ...
      \begin{column}{0.59\textwidth}
        ...
        \ii<4-> Typsignatur durch Typsystem ermitteln {
          \bi
          \ii Anzahl und Typen der Parameter ermitteln
          \ii Anzahl und Typen der Argumente ermitteln
          \ei
        }\medskip
...
#+begin_src latex
\begin{frame}{Polymorphe Typsysteme und Überladung}

\end{frame}
#+end_src
** Einfluss von Dynamischen Typen
- Single Dispatch
- Multiple Dispatch
* Summary
