...
* Namensräume und Namensauflösung
  ...
  \begin{frame}{Implizite Namensauflösung}
    \begin{columns}
      ...
      \begin{column}{0.65\textwidth}
        ...
        \ii<2-> \enquote{Closest-nested scope rule}{
          \bi
...
#+begin_src latex
  ...
  \begin{frame}{Einschränkung der Sichtbarkeit}
    ...
    \ii<2-> Definitionen bekommen ein weiteres Attribut\hfill\texttt{\LETi <NAME>}{
      \bi
      \ii Interne Definitionen können nur über implizite Auflößung gefunden werden.
...
** Aliase und Uneindeutige Auflösung
