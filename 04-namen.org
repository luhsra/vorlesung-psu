...
PROG  -> DECL*
DECL  -> SCOPE
SCOPE -> '{' DECL* '}' // Namensräume können geschachtelt sein
DECL  -> 'let' NAME    // Deklaration eines Namens
DECL  -> NAME          // Verwendung  eines Namens
#+end_example
...
#+begin_src latex
  \begin{frame}{Einschränkung der Sichtbarkeit}
    ...
    \bi
    \ii<2-> Deklarationen bekommen ein weiteres Attribut\hfill\texttt{\LETi <NAME>}{
      \bi
