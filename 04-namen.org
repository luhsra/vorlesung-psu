  ...
  \begin{frame}{Implizite Namensauflösung}
    \begin{columns}
      ...
      \begin{column}{0.65\textwidth}
        ...
        \ii<2-> \enquote{Closest-nested scope rule} (CSNR){
          \bi
...
#+begin_src latex
  ...
  \begin{frame}{Function-Call Frames und Rekursive Funktionen}
    \textbf{Früher} (z.B. Fortran 77) hat man Rekursion und geschachtelte Funktionen einfach nicht unterstützt. \medskip
