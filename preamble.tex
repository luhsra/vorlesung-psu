...
%** code blocks **************************************************************
  ...
  \DeclareDocumentCommand{\codebox}{O{codecolor}}{\Colorbox{#1}}
  \DeclareDocumentCommand{\codeinline}{D<>{1-}O{}v}{%
    \only<#1>{%
      \codebox{\csname lstinline\endcsname[#2]!#3!}%
    }%
  }
...
, morekeywords=[5]{assert!, assert_eq!, assert_ne!, cfg!, column!, compile_error!, concat!, concat_idents!, debug_assert!, debug_assert_eq!, debug_assert_ne!, env!, eprint!, eprintln!, file!, format!, format_args!, include!, include_bytes!, include_str!, line!, module_path!, option_env!, panic!, print!, println!, select!, stringify!, thread_local!, try!, unimplemented!, unreachable!, vec!, write!, writeln!}  % prelude macros
  ...
  \lstloadlanguages{C,C++,Java,sh,[x86masm]Assembler,rust}
...
\lstnewenvironment{pascal}[1][]{
  \lstset{style=pascal, autogobble, #1}
} {}
...
% Signaturen
\newcommand{\siginline}[4][\scriptsize]{%
  \Colorbox{badbee!20}{#1#2\hspace{1ex}\texttt{::}\hspace{1ex}#3\hspace{1ex}$\mapsto$\hspace{1ex}#4}%
}

% Typausdrücke
\colorlet{typecolor}{safegreen!30}
\newcommand{\typeinline}[2][\scriptsize]{%
  \colorbox{typecolor}{#1#2}%
}
